class AnswersController < ApplicationController
  def create
    ...
    notification = @question.user.answer_notifications.create!(:question_url => question_url(@question))

    notification_data = {:url => notification_url(notification, :type => :a), :type => :a}
